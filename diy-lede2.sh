...
sed -i "s/R21.7.26/R21.7.26 build $(TZ=UTC-8 date "+%Y.%m.%d") /g" package/lean/default-settings/files/zzz-default-settings
...
find . -name bypass.lua | xargs sed -i "s/Bypass/科学上网国旗版/g"
find . -name bypass.po | xargs sed -i '/msgstr/s/Bypass/SSR+国旗版/g'
