...
sed -i "s/19.07-SNAPSHOT/19.07 build $(TZ=UTC-8 date "+%Y.%m.%d") /g" package/default-settings/files/zzz-default-settings
...
sed -i '/msgstr/ { s/ShadowSocksR Plus+ 设置/科学上网设置/g;  s/ShadowSocksR/科学上网Plus+/g; }' package/openwrt-packages/luci-app-ssr-plus/po/zh-cn/ssr-plus.po
sed -i 's/"ShadowSocksR Plus+"/"科学上网Plus+"/g' package/openwrt-packages/luci-app-ssr-plus/luasrc/controller/shadowsocksr.lua
sed -i "s#ShadowsocksR Plus+ #科学上网程序#g" package/openwrt-packages/luci-app-ssr-plus/luasrc/view/shadowsocksr/status.htm
sed -i 's/"PassWall"/"正确姿势翻墙✔"/g' feeds/diy1/lienol/luci-app-passwall/po/zh-cn/passwall.po
# sed -i 's/PassWall/正确姿势翻墙✔/g' package/openwrt-packages/luci-app-passwall/Makefile
