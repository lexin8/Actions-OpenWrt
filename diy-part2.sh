...
sed -i 's/"msgstr "ShadowSocksR Plus+ 设置"/"msgstr "科学上网设置"/g' package/openwrt-packages/luci-app-ssr-plus/po/zh-cn/ssr-plus.po
sed -i 's/"ShadowSocksR Plus+"/"科学上网"/g' package/openwrt-packages/luci-app-ssr-plus/luasrc/controller/shadowsocksr.lua
sed -i 's/"msgstr "ShadowSocksR"/"msgstr "科学上网"/g' package/openwrt-packages/luci-app-ssr-plus/po/zh-cn/ssr-plus.po
